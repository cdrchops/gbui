...
public class BTextField extends BTextComponent
    ...
    /**
     * Configures this text field with the specified text for display and editing. The cursor will be adjusted if this
     * text is shorter than its previous position.
     */
